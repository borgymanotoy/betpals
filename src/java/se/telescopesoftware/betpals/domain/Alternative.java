...
public class Alternative implements Comparable<Alternative> {
	...
	public int compareTo(Alternative alternative) {
		...
		if(alternative!=null){
			...
			Integer priority2 = alternative.getPriority();

			Long id1 = this.getId();
			Long id2 = alternative.getId();
			int idResult = id1.compareTo(id2);

			if(priority1 == null || priority2 == null) return idResult;
			if(priority1 == priority2) return idResult;
