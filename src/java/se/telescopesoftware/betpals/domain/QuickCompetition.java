...
public class QuickCompetition {
	...
	public QuickCompetition() {
		this.accessType = AccessType.FRIENDLY;
	}
	...
	public boolean isPublicCompetition() {
		return getAccessType() == AccessType.PUBLIC;
	}

	public void setPublicCompetition(boolean bool) {
		setAccessType(bool ? AccessType.PUBLIC : AccessType.FRIENDLY);
	}
