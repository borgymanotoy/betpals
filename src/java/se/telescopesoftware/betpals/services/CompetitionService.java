...
public interface CompetitionService {
    ...
    /** Returns the SiteConfigurationService object.
    *
    *  This method returns a SiteConfigurationService object that can be used to get a parameter value from the site configuration (config.properties).
    */
	SiteConfigurationService getSiteConfigurationService();
}
