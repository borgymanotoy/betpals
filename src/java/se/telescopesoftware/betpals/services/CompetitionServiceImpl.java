...
public class CompetitionServiceImpl implements CompetitionService {
	...
	private void sendInvitationByMail(Invitation invitation, Locale locale) {
		try {
			...
			String site_url = getSiteConfigurationService().getParameterValue("site.url", "http://www.mybetpals.com/");
			model.put("siteUrl", site_url);

			Competition competition = getCompetitionById(invitation.getCompetitionId());
	...
	public SiteConfigurationService getSiteConfigurationService() {
