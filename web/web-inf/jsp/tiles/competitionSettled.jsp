...
<div class="rbDiv contentDiv">
    ...
    <div>
        <spring:message code="competition.competition.settled.deadline"/>: <span class="bold"><fmt:formatDate value="${competition.deadline}" pattern="yyyy-MM-dd HH:mm"/></span>
    </div>
    <div>
        <spring:message code="competition.settled.settling.deadline"/>: <span class="bold"><fmt:formatDate value="${competition.settlingDeadline}" pattern="yyyy-MM-dd HH:mm"/></span>
    </div>
    <p>&nbsp;</p>
            ...
            <div class="span-12">
                ...
                <div class="span-10 last">
                    ...
                    <c:forEach items="${altFromList.bets}" var="bet">
                        ...
                        <c:choose>
                            <c:when test="${bet.ownerId == competition.ownerId}">
                                <spring:message code="competition.you"/>
                            </c:when>
                            <c:otherwise>
                                <a href='<c:url value="/viewprofile/${bet.ownerId}.html"/>'>${bet.ownerName}</a>
                            </c:otherwise>
                        </c:choose> 
                        <spring:message code="bet"/>
                         ${bet.stake} ${competition.currency}
                         <spring:message code="and"/>
                        <c:choose>
                            <c:when test="${bet.won}">
                                <spring:message code="bet.won"/>
                            </c:when>
                            <c:otherwise>
                                <spring:message code="bet.lost"/>
                            </c:otherwise>
                        </c:choose> 
                        <fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${bet.wonOrLostAmount}"/> ${competition.currency}
                         </span><br/>
                    </c:forEach>
