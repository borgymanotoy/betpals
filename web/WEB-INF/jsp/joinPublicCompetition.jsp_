                                        ...
                                        <div class="span-5 last right">
                                            <c:choose>
                                                <c:when test="${competition.competitionType == 'POOL_BETTING'}">
                                                    <input type="text" id="myStake_${altFromList.id}" size="3" maxlength="3" name="stake" class="positive_number_only" onkeypress="getInvitationDetailsByKeypress(event, ${competition.id}, ${altFromList.id});" /> ${competition.currency}&nbsp;
                                                </c:when>
                                                <c:otherwise>
