...
<form:hidden path="ownerId"/>
    ...
    <div class="span-12 formSectionSlimDiv">
        <div class="span-2 labelDiv" style="padding-top: 8px;">Friends</div>
    ...
    <div class="span-12 formSectionSlimDiv">
        ...
        <div class="span-10 last">
           ...
           <button class="blueButton110" onclick="backToGroupList(); return false;">Cancel</button>
        </div>
    </div>
</form:form>
             <p>&nbsp;</p>
