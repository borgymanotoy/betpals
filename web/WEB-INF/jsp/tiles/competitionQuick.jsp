...
<div class="rbDiv contentDiv">
    ...
    <div class="formSectionDiv">
        <input type="radio" name="accessType" value="PUBLIC" <c:if test="${quickCompetition.accessType == 'PUBLIC'}">checked="checked"</c:if>/><spring:message code="competition.access.type.public"/><br/>
        <input type="radio" name="accessType" value="FRIENDLY" <c:if test="${quickCompetition.accessType == 'FRIENDLY'}">checked="checked"</c:if>/><spring:message code="competition.access.type.friendly"/><br/>
        <input type="radio" name="accessType" value="PRIVATE" <c:if test="${quickCompetition.accessType == 'PRIVATE'}">checked="checked"</c:if>/><spring:message code="competition.access.type.private"/>
    </div>
