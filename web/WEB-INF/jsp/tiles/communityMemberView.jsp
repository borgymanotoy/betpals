...
<script type="text/javascript">
	function getInvitationDetails(invitationId, competitionId) {
	    jQuery('#invitationId').val(invitationId);
	...
	var removeActivity = function(activityId) {
		jQuery("#confirmDelete").data('activityId',activityId).dialog('open');
	};
	var removeActivityAction = function(activityId) {
        ...
        <li>
            <div class="span-12">
                ...
                <div class="span-10 last invitationDiv">
                    <h5 onclick="getInvitationDetails('${invitation.id}', '${invitation.competitionId}');">${invitation.competitionName}</h5>
