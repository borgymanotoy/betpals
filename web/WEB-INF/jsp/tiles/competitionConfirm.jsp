...
<script type="text/javascript">
   ...
   function goToNextStep() {
	...
	var setSaveConfirmButtonAccordingToAlternativesCount = function(){
	...
	jQuery(document).ready(function() {
		setSaveConfirmButtonAccordingToAlternativesCount();
    });
</script>
<div>
...
<div class="rbDiv contentDiv">
    ...
    <button id="btnBack" class="blueButton110" onclick="goBack();"><spring:message code="button.back"/></button>
    <button id="btnCancel" class="whiteButton90" onclick="goHome();"><spring:message code="button.cancel"/></button>
    <button id="btnSaveExit" class="greenButton110" onclick="saveAndExit();"><spring:message code="button.save.and.exit"/></button>
    <button id="btnSaveConfirm" class="blueButton110" onclick="goToNextStep();"><spring:message code="button.confirm"/></button>
    <p>&nbsp;</p>
</div>
