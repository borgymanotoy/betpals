...
<div id="leftPane" class="span-5">
    ...
    <div class="span-3 last">
        ...
        <input type="button" id="editProfileButton" onclick="window.location = '<c:url value="/editprofile.html"/>'" value="<spring:message code='button.edit.profile'/>"/>
    </div>
    <div id="leftBlock" class="span-5">
	    ...
	    <div class="leftPaneInside">
			<table id="tblPanel">
				<tr>
					<td id="tdBullet" width="12"><a href='<c:url value="/addaccount.html"/>'><img src='<c:url value="/i/greenDot.jpg"/>' /></a></td>
					<td id="tdLink" width="143"><a href='<c:url value="/addaccount.html"/>'><spring:message code="button.add.account"/></a></td>
				</tr>
			</table>
		</div>
	    ...
	    <div class="panel" style="padding: 10px;">
			<table id="tblPanel">
				<tr>
					...
					<td id="tdLink"><a href='<c:url value="/allfriends.html"/>'><spring:message code="link.all.friends"/></a></td>
				</tr>
				<tr>
					<td id="tdBullet"><a href='<c:url value="/myrequests.html"/>'><img src='<c:url value="/i/greenDot.jpg"/>' /></a></td>
					<td id="tdLink"><a href='<c:url value="/myrequests.html"/>'><spring:message code="link.new.requests"/> (${myRequestsCount})</a></td>
				</tr>
			</table>
